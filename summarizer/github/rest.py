...
from summarizer.github.utils import parse_link_header, extract_number, parse_iso
...
class RESTClient:
    ...
    def fetch_comments(
        ...
        if ChangeType.PR_COMMENT in set(self.config.include_types):
            results.extend(self._fetch_pr_review_comments(repos, start, end, viewer_login))
            ...
            while next_url:
                ...
                for comment in comments:
                    ...
                    results.append(Change(
                        ...
                        summary=comment.get("body", "")[:200] if comment.get("body") else None,
                        metadata={
                            "number": number or "",
                            "type": "issue"
                        }
